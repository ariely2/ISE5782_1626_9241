...
public class ReflectionRefractionTests {
	...
	public void SoftShadowTest()
	{
		...
		scene.geometries.add( //
				new Triangle(new Point(-150, -200, 0), new Point(150, -150, -165), new Point(75, 75, -150)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(20)), //
				//new Triangle(new Point(-150, -150, -115), new Point(-70, 70, -140), new Point(75, 75, -150)) //
				//		.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(20)), //
				//new Sphere(new Point(-60, 70, 0), 30d).setEmission(new Color(50, 250, 500)) //
				//		.setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30)),
				new Sphere(new Point(50, -20, -100), 40d).setEmission(new Color(70, 150, 350)) //
