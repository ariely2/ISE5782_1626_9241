...
public class ReflectionRefractionTests {
	...
	public void everything() {
		...
		scene.setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.20)));
	...
	public void SoftShadowTest()
	{
		...
		scene.geometries.add( //
				...
				new Triangle(new Point(-150, -150, -115), new Point(-70, 70, -140), new Point(75, 75, -150)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)), //
				new Sphere(new Point(-60, 70, 40), 30d).setEmission(new Color(250, 100, 250)) //
						.setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30)),
				new Sphere(new Point(50, -20, -100), 30d).setEmission(new Color(50, 100, 100)) //
						.setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(40)));

		scene.lights.add(new PointLight(new Color(130, 100, 100), new Point(50, 50, 100), 15, 70) //
				.setKl(4E-5).setKq(2E-7));
		scene.lights.add(new SpotLight(new Color(260,150,150), new Point(100, 100, 90), 15, new Vector(-1,0,-1),  70) //
				.setKl(4E-5).setKq(2E-7));
